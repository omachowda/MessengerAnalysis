---
title: "Rehab’s Messenger Analysis"
...
#File Read 
result = fromJSON(file =  "/Users/omachowda/Desktop/Projects/Messenger Analysis/messages/inbox/RehabKhan_UN6XWmBv4w/message.json")
#Data Head
...
df <- data.frame(
  sender = factor(c('You', 'Me'),
                  levels = c('You', 'Me')),
  value = c(as.numeric(as.character(tbl['Rehab Khan'])),
